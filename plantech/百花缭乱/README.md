...
| 文件 | 说明 |
|---|---|
| `plantech_msg_extract_v3.py` | 文本或资源提取脚本；plantech_msg_extract.py v3 — PLANTECH MESSAGE 文本提取 |
| `plantech_msg_inject_v3.py` | 文本注入脚本；plantech_msg_inject.py v3 — PLANTECH MESSAGE 文本注入 |
| `setup_registry_admin.bat` | 构建/安装批处理脚本 |
...
```bash
python plantech_msg_extract_v3.py <原始脚本或目录> <导出json或目录>
# 翻译/修改导出的 JSON
python plantech_msg_inject_v3.py <原始脚本或目录> <翻译json或目录> <输出脚本或目录>
```
