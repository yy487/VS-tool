...
| 文件 | 说明 |
|---|---|
| `snr_extract_v2.py` | 文本或资源提取脚本；SNR 脚本文本提取工具 v2.1 — 字节码遍历, 支持 STSL + BTSL |
| `snr_inject_v2.py` | 文本注入脚本；SNR 脚本文本注入工具 v2.1 — 字节码遍历 + 跳转修正, 支持 STSL + BTSL |
...
```bash
python snr_extract_v2.py <原始脚本或目录> <导出json或目录>
# 翻译/修改导出的 JSON
python snr_inject_v2.py <原始脚本或目录> <翻译json或目录> <输出脚本或目录>
```
