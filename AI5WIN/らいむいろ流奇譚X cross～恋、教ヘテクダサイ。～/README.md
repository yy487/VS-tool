...
| 文件 | 说明 |
|---|---|
| `arc_tool.py` | 封包解析/解包/重打包工具；Line2 Engine ARC Archive Tool (通用版) |
| `mes_extract.py` | 文本或资源提取脚本；Line2 Engine MES Script Text Extractor |
| `mes_inject.py` | 文本注入脚本；AI5WIN (Line2) Engine MES Script Text Injector |
...
如需先处理封包/归档文件，可查看这些脚本的参数：`arc_tool.py`。
