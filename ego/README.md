...
| 子目录 | 说明 |
|---|---|
| `tiny/` | 文本提取与注入工具目录，通常用于脚本翻译的导出、翻译回写与回归验证。 关键文件：bsf1_codec.py, dat_tool.py, scr_extract.py ... |
| `twin way重置/` | 逆向与本地化辅助工具目录，脚本为当前目标作品/格式定制。 关键文件：scr2_codec (1).py, scr2_inject (1).py, scr2_inject (2).py |
