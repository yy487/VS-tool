...
| 文件 | 说明 |
|---|---|
| `mes_extract.py` | 文本或资源提取脚本；mes_extract.py - ADVWIN32 MES script text extractor |
| `mes_inject.py` | 文本注入脚本；mes_inject.py - ADVWIN32 MES script text injector |
| `mrg_tool.py` | 封包解析/解包/重打包工具；mrg_tool.py - F&C Co. MRG archive unpack/repack tool |
...
如需先处理封包/归档文件，可查看这些脚本的参数：`mrg_tool.py`。
